...
public class ElasticsearchExtendRestFactory extends ElasticsearchRestFactory{
	public ElasticsearchExtendRestFactory() {
		super();
	}
	public ElasticsearchExtendRestFactory(String servers) {
		super(servers);
	}
	public ElasticsearchExtendRestFactory(String servers,int port) {
		super(servers, port);
	}
	public ElasticsearchExtendRestFactory(String clusterName, String servers,int port) {
		super(clusterName, servers, port);
	}
	public ElasticsearchExtendRestFactory(String clusterName, String servers, String username, String password) {
		super(clusterName, servers, username, password);
	}
	public ElasticsearchExtendRestFactory(String clusterName, String servers, String username, String password,int port) {
